	...
	var p5functions = {
	    ...
	    mouseDragged: function mouseDragged() {
	        if (initMousePos && hand != undefined) {
	            var selector = document.getElementById('blend-mode-selector');
	            var selected = selector.options[selector.selectedIndex].value;
	            var blendMode = selected ? window[selected.toUpperCase()] : LIGHTEST;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UnsteadyHand = (function () {
	  ...
	  _createClass(UnsteadyHand, [{
	    ...
	    key: "addRotation",
	    value: function addRotation(rotation) {
	      if (rotation) {
